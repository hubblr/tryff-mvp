const {
  ...
  reduceStockQuantity,
} = require("./airtable/stock");
const {
  getAirtableVendorByName,
  getAirtableVendorCheckoutOptions,
} = require("./airtable/vendor");
const { getAirtableLocalWarehouse } = require("./airtable/localWarehouse");
const { createAirtableTablesForOrder } = require("./airtable/order");
const { getShopifyOrder, completeShopifyFulfillment } = require("./shopify");
